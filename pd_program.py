...
result_df = pd.read_csv(r'C:\Users\user\Desktop\dash_app\result_df.csv')
result_df_p = pd.read_csv(r'C:\Users\user\Desktop\dash_app\result_df_p.csv')
df_swing_table_all = pd.read_csv(r'C:\Users\user\Desktop\dash_app\df_swing_table_all.csv')
...
# [중요] 전부 제대로 작동되는지 확인하기
# 백분위수 규정을 채운 경우 hovertext에서 백분위수는 출력하지 않도록 하기 O
# compare all similar batters/pitchers에서 마우스 커서 시 plate discipline 기록 다 나오게 하기 O
# 레이어 하나 더 만들어서 지표 설명 및 사용법 기록하기

# 감수 받을 때
# 1. percentile ranking 높고 낮으면 좋은 스탯 확인받기
# 2. compare all similar batters/pitchers
